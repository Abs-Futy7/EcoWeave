    ...
    <div className="h-full bg-background">
      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-card border border-border rounded-lg p-4">
            <div className="text-sm text-foreground/60 mb-1">Medium Risk</div>
            <div className="text-2xl font-bold text-orange-600">
              {batches.filter(b => b.risk_score >= 50 && b.risk_score < 75).length}
            </div>
          </div>
          <div className="bg-card border border-border rounded-lg p-4">
            <div className="text-sm text-foreground/60 mb-1">Low Risk</div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div>
              <select
                ...
                className="px-4 py-2 border border-border rounded-lg text-sm bg-background cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary"
              >
