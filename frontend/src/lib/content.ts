...
export const pricingTiers = [
  {
    name: "Pilot",
    price: "Contact Us",
    description: "Perfect for testing the platform with a single production line or facility.",
    features: [
  ...
  },
  {
    name: "Standard",
    price: "Custom",
    description: "Comprehensive monitoring for medium-sized facilities with multiple production lines.",
    features: [
      "Up to 5 production lines",
      "Full forensic validation",
